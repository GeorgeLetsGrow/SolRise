...
<section className="contact contact-page"><div className="contact-intro"><p className="eyebrow light">What happens next</p><h2>A simple, supportive first step.</h2><ol className="contact-steps"><li><span>1</span><p><strong>Send your inquiry</strong>Tell us about your learner and what you hope will improve.</p></li><li><span>2</span><p><strong>Hear from an educator</strong>We&apos;ll follow up to clarify needs and answer questions.</p></li><li><span>3</span><p><strong>Choose your next step</strong>If we&apos;re a good fit, we&apos;ll recommend a service and format.</p></li></ol><div className="contact-links"><a href="mailto:solriselearning@gmail.com">solriselearning@gmail.com</a><a href="tel:+16172819357">(617) 281-9357</a></div></div><ContactForm/></section><SiteFooter/></main>}
