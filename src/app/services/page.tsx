...
const items = [
  ...
  { title:"Reading K–6", text:"Develop phonics, fluency, vocabulary, and comprehension through engaging lessons designed around each reader.", meta:"Early literacy · Comprehension · Writing connections", image:"/yamilka-hands-on-learning.jpg" },
  ...
  { title:"Test Prep", text:"Prepare with a focused plan, targeted skill review, practice questions, and test-taking strategies that build confidence.", meta:"SAT · ACT · FAST · CLT", image:"/online-math-session.jpg" },
  { title:"Academic Success Coaching", text:"Create reliable systems for organization, study habits, planning, and goal-setting so school feels more manageable.", meta:"Executive skills · Study plans · Accountability", image:"/yamilka-student-teamwork.jpg" },
  { title:"Homeschool Portfolio Evaluation", text:"Receive a thoughtful, comprehensive review of your learner’s academic work and documentation.", meta:"Portfolio review · Progress summary · Next steps", image:"/-post-ai-image-19422.png" },
  { title:"Academic Transition Support", text:"Navigate a move between homeschool and traditional school with guidance on planning, records, and curriculum alignment.", meta:"Planning · Documentation · Curriculum alignment", image:"/-post-ai-image-262403.png" },
];
