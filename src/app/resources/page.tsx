...
<section className="content-split section soft"><div><p className="eyebrow">A helpful reminder</p><h2>You don&apos;t have to recreate school at home.</h2></div><div><p>Your most valuable role is creating a supportive rhythm: show interest, protect time for practice, and help your learner ask for what they need. When a skill requires specialized instruction, that&apos;s where we can partner with you.</p><a className="text-link" href="/contact">Ask an educator →</a></div></section>
<section className="page-cta"><h2>Need guidance for a specific challenge?</h2><a className="button button-light" href="/contact">Start a conversation</a></section><SiteFooter/></main>}
