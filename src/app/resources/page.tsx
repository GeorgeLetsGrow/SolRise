...
const groups = [
  { title:"Math", intro:"Build skills, review concepts, and practice at your learner’s pace.", links:[
    ["Desmos Graphing Calculator","Explore functions, plot data, and visualize mathematical relationships with a free online graphing calculator.","https://www.desmos.com/calculator"],
