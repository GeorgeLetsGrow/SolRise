...
<section className="policy-note section"><div><p className="eyebrow">Questions are welcome</p><h2>We want every detail to feel clear.</h2></div><div><p>If you have a question about payment, scholarship funds, travel, or scheduling, please reach out before your session. We&apos;re happy to talk it through.</p><div className="policy-contacts"><a href="mailto:solriselearning@gmail.com">solriselearning@gmail.com</a><a href="tel:+18138420668">(813) 842-0668</a></div></div></section>
